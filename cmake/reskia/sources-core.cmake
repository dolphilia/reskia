...
if(RESKIA_ENABLE_SKSG OR RESKIA_ENABLE_SKOTTIE)
    ...
    foreach(_reskia_gni_line IN LISTS _reskia_sksg_gni_lines)
        ...
        if(_reskia_gni_path)
            ...
            list(APPEND _reskia_sksg_sources "${_reskia_module_path}")
        endif()
    endforeach()

    list(REMOVE_DUPLICATES _reskia_sksg_sources)
    list(APPEND SOURCE_FILES ${_reskia_sksg_sources})
endif()
...
if(RESKIA_ENABLE_SKOTTIE)
    ...
    foreach(_reskia_gni_line IN LISTS _reskia_skottie_gni_lines)
        string(REGEX MATCH "\\$_modules/[^\" ]+" _reskia_gni_path "${_reskia_gni_line}")
        if(_reskia_gni_path)
            string(REPLACE "$_modules/" "modules/" _reskia_module_path "${_reskia_gni_path}")
