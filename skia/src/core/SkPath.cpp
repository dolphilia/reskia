...
void SkPath::transform(const SkMatrix& matrix, SkPath* dst, SkApplyPerspectiveClip) const {
    this->transform(matrix, dst);
}

void SkPath::transform(const SkMatrix& matrix, SkApplyPerspectiveClip) {
    this->transform(matrix);
}

SkPath SkPath::makeTransform(const SkMatrix& m, SkApplyPerspectiveClip) const {
