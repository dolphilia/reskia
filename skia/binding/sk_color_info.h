...
sk_color_info_t SkColorInfo_makeAlphaType(reskia_color_info_t *color_info, int newAlphaType); // (SkColorInfo *color_info, SkAlphaType newAlphaType) -> sk_color_info_t
...
sk_color_info_t SkColorInfo_makeColorType(reskia_color_info_t *color_info, int newColorType); // (SkColorInfo *color_info, SkColorType newColorType) -> sk_color_info_t
