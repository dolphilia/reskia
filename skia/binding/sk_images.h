...
sk_image_t SkImages_RasterFromCompressedTextureData(sk_data_t data, int width, int height, int type); // (sk_data_t data, int width, int height, SkTextureCompressionType type) -> sk_image_t
