...
int SkFlattenable_getFactory(reskia_flattenable_t *flattenable); // (SkFlattenable *flattenable) -> sk_flattenable_factory_t
...
int SkFlattenable_getFlattenableType(reskia_flattenable_t *flattenable); // (SkFlattenable *flattenable) -> SkFlattenable::Type
int SkFlattenable_serialize(reskia_flattenable_t *flattenable, const reskia_serial_procs_t *serial_procs); // (SkFlattenable *flattenable, const SkSerialProcs *serial_procs) -> sk_data_t
...
int SkFlattenable_Deserialize(int type, const uint8_t *data, size_t length, const reskia_deserial_procs_t *procs); // (SkFlattenable::Type type, const void *data, size_t length, const SkDeserialProcs *procs) -> int
