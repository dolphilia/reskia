...
extern "C" {
SkMeshSpecification::Result SkMeshSpecification_Make(SkSpan<const SkMeshSpecification::Attribute> attributes,
                   size_t                  vertexStride,
                   SkSpan<const SkMeshSpecification::Varying>   varyings,
                   const SkString&         vs,
                   const SkString&         fs) {
    return SkMeshSpecification::Make(attributes, vertexStride, varyings, vs, fs);
}
SkMeshSpecification::Result SkMeshSpecification_Make_2(SkSpan<const SkMeshSpecification::Attribute> attributes,
                   size_t                  vertexStride,
                   SkSpan<const SkMeshSpecification::Varying>   varyings,
                   const SkString&         vs,
                   const SkString&         fs,
...
SkMeshSpecification::Result SkMeshSpecification_Make_3(SkSpan<const SkMeshSpecification::Attribute> attributes,
                   size_t                  vertexStride,
                   SkSpan<const SkMeshSpecification::Varying>   varyings,
                   const SkString&         vs,
                   const SkString&         fs,
...
SkSpan<const SkRuntimeEffect::Uniform> SkMeshSpecification_uniforms(SkMeshSpecification* spec) {
    return spec->uniforms();
}

SkSpan<const SkRuntimeEffect::Child> SkMeshSpecification_children(SkMeshSpecification* spec) {
