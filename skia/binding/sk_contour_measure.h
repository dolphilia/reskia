...
void SkContourMeasure_delete(void *contour_measure); // owned: caller が保持する参照を release する (SkContourMeasure *contour_measure)
...
void SkContourMeasure_ref(void *contour_measure); // retained: 参照カウントを増やす (SkContourMeasure *contour_measure)
void SkContourMeasure_unref(void *contour_measure); // owned: 参照カウントを減らす (SkContourMeasure *contour_measure)
