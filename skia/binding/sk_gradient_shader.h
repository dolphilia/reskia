...
sk_shader_t SkGradientShader_MakeLinear_2(const reskia_point_t *pts, const reskia_color_4f_t *colors, sk_color_space_t color_space, const float *pos, int count, reskia_gradient_shader_tile_mode_t mode, const reskia_gradient_shader_interpolation_t *interpolation, const reskia_matrix_t *localMatrix); // (const SkPoint pts[2], const SkColor4f colors[], sk_color_space_t color_space, const SkScalar pos[], int count, SkTileMode mode, const SkGradientShader::Interpolation *interpolation, const SkMatrix *localMatrix) -> sk_shader_t
sk_shader_t SkGradientShader_MakeLinear_3(const reskia_point_t *pts, const reskia_color_4f_t *colors, sk_color_space_t color_space, const float *pos, int count, reskia_gradient_shader_tile_mode_t mode, uint32_t flags, const reskia_matrix_t *localMatrix); // (const SkPoint pts[2], const SkColor4f colors[], sk_color_space_t color_space, const SkScalar pos[], int count, SkTileMode mode, uint32_t flags, const SkMatrix *localMatrix) -> sk_shader_t
...
sk_shader_t SkGradientShader_MakeRadial_3(const reskia_point_t *center, float radius, const reskia_color_4f_t *colors, sk_color_space_t color_space, const float *pos, int count, reskia_gradient_shader_tile_mode_t mode, uint32_t flags, const reskia_matrix_t *localMatrix); // (const SkPoint *center, SkScalar radius, const SkColor4f colors[], sk_color_space_t color_space, const SkScalar pos[], int count, SkTileMode mode, uint32_t flags, const SkMatrix *localMatrix) -> sk_shader_t
...
sk_shader_t SkGradientShader_MakeTwoPointConical_3(const reskia_point_t *start, float startRadius, const reskia_point_t *end, float endRadius, const reskia_color_4f_t *colors, sk_color_space_t color_space, const float *pos, int count, reskia_gradient_shader_tile_mode_t mode, uint32_t flags, const reskia_matrix_t *localMatrix); // (const SkPoint *start, SkScalar startRadius, const SkPoint *end, SkScalar endRadius, const SkColor4f colors[], sk_color_space_t color_space, const SkScalar pos[], int count, SkTileMode mode, uint32_t flags, const SkMatrix *localMatrix) -> sk_shader_t
