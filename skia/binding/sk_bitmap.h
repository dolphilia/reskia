...
int SkBitmap_asImage(reskia_bitmap_t *bitmap); // (SkBitmap *bitmap) -> sk_image_t
int SkBitmap_bounds(reskia_bitmap_t *bitmap); // (SkBitmap *bitmap) -> sk_i_rect_t
...
int SkBitmap_dimensions(reskia_bitmap_t *bitmap); // (SkBitmap *bitmap) -> sk_i_size_t
...
void SkBitmap_erase_2(reskia_bitmap_t *bitmap, int c, const reskia_i_rect_t *area); // (SkBitmap *bitmap, sk_color_4f_t c, const SkIRect *area)
...
void SkBitmap_eraseColor_2(reskia_bitmap_t *bitmap, int c); // (SkBitmap *bitmap, sk_color_4f_t c)
...
int SkBitmap_getColor4f(reskia_bitmap_t *bitmap, int x, int y); // (SkBitmap *bitmap, int x, int y) -> sk_color_4f_t
...
int SkBitmap_getSubset(reskia_bitmap_t *bitmap); // (SkBitmap *bitmap) -> sk_i_rect_t
int SkBitmap_height(reskia_bitmap_t *bitmap); // (SkBitmap *bitmap) -> int
int SkBitmap_info(reskia_bitmap_t *bitmap); // (SkBitmap *bitmap) -> sk_image_info_t
...
int SkBitmap_makeShader(reskia_bitmap_t *bitmap, const reskia_sampling_options_t *sampling, const reskia_matrix_t *lm); // (SkBitmap *bitmap, const SkSamplingOptions *sampling, const SkMatrix *lm) -> sk_shader_t
int SkBitmap_makeShader_2(reskia_bitmap_t *bitmap, const reskia_sampling_options_t *sampling, const reskia_matrix_t *lm); // (SkBitmap *bitmap, const SkSamplingOptions *sampling, const SkMatrix *lm) -> sk_shader_t
int SkBitmap_makeShader_3(reskia_bitmap_t *bitmap, int tmx, int tmy, const reskia_sampling_options_t *sampling, const reskia_matrix_t *localMatrix); // (SkBitmap *bitmap, SkTileMode tmx, SkTileMode tmy, const SkSamplingOptions *sampling, const SkMatrix *localMatrix) -> sk_shader_t
int SkBitmap_makeShader_4(reskia_bitmap_t *bitmap, int tmx, int tmy, const reskia_sampling_options_t *sampling, const reskia_matrix_t *lm); // (SkBitmap *bitmap, SkTileMode tmx, SkTileMode tmy, const SkSamplingOptions *sampling, const SkMatrix *lm) -> sk_shader_t
...
int SkBitmap_pixelRefOrigin(reskia_bitmap_t *bitmap); // (SkBitmap *bitmap) -> sk_i_point_t
...
int SkBitmap_refColorSpace(reskia_bitmap_t *bitmap); // (SkBitmap *bitmap) -> sk_color_space_t
...
void SkBitmap_setPixelRef(reskia_bitmap_t *bitmap, int pixelRef, int dx, int dy); // (SkBitmap *bitmap, sk_pixel_ref_t pixelRef, int dx, int dy)
