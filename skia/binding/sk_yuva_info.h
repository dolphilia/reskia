...
int SkYUVAInfo_dimensions(reskia_yuva_info_t *yuva_info); // (SkYUVAInfo *yuva_info) -> sk_i_size_t
...
int SkYUVAInfo_originMatrix(reskia_yuva_info_t *yuva_info); // (SkYUVAInfo *yuva_info) -> sk_matrix_t
...
int SkYUVAInfo_makeSubsampling(reskia_yuva_info_t *yuva_info, int subsampling); // (SkYUVAInfo *yuva_info, SkYUVAInfo::Subsampling subsampling) -> sk_yuva_info_t
int SkYUVAInfo_makeDimensions(reskia_yuva_info_t *yuva_info, int size); // (SkYUVAInfo *yuva_info, sk_i_size_t size) -> sk_yuva_info_t
...
int SkYUVAInfo_PlaneDimensions(int imageDimensions, int plane, int subsampling, int origin, reskia_i_size_t *planeDimensions); // (sk_i_size_t imageDimensions, SkYUVAInfo::PlaneConfig plane, SkYUVAInfo::Subsampling subsampling, SkEncodedOrigin origin, SkISize planeDimensions[SkYUVAInfo::kMaxPlanes]) -> int
