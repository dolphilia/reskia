...
void SkCanvas_clipShader(reskia_canvas_t *canvas, int shader, int op); // (SkCanvas *canvas, sk_shader_t shader, SkClipOp op)
...
void SkCanvas_drawAnnotation(reskia_canvas_t *canvas, const void *rect, const char * key, int data); // (SkCanvas *canvas, const SkRect *rect, const char key[], sk_data_t data)
...
void SkCanvas_drawCircle(reskia_canvas_t *canvas, int center, float radius, const void *paint); // (SkCanvas *canvas, sk_point_t center, SkScalar radius, const SkPaint *paint)
...
void SkCanvas_drawGlyphs(reskia_canvas_t *canvas, int count, const void * glyphs, const void * positions, const void * clusters, int textByteCount, const char * utf8text, int origin, const void *font, const void *paint); // (SkCanvas *canvas, int count, const SkGlyphID glyphs[], const SkPoint positions[], const uint32_t clusters[], int textByteCount, const char utf8text[], sk_point_t origin, const SkFont *font, const SkPaint *paint)
void SkCanvas_drawGlyphs_2(reskia_canvas_t *canvas, int count, const void * glyphs, const void * positions, int origin, const void *font, const void *paint); // (SkCanvas *canvas, int count, const SkGlyphID glyphs[], const SkPoint positions[], sk_point_t origin, const SkFont *font, const SkPaint *paint)
void SkCanvas_drawGlyphs_3(reskia_canvas_t *canvas, int count, const void * glyphs, const void * xforms, int origin, const void *font, const void *paint); // (SkCanvas *canvas, int count, const SkGlyphID glyphs[], const SkRSXform xforms[], sk_point_t origin, const SkFont *font, const SkPaint *paint)
void SkCanvas_drawImage(reskia_canvas_t *canvas, int image, float left, float top); // (SkCanvas *canvas, sk_image_t image, SkScalar left, SkScalar top)
void SkCanvas_drawImage_2(reskia_canvas_t *canvas, int image, float x, float y, const void *sampling, const void *paint); // (SkCanvas *canvas, sk_image_t image, SkScalar x, SkScalar y, const SkSamplingOptions *sampling, const SkPaint *paint)
...
void SkCanvas_drawImageRect(reskia_canvas_t *canvas, int image, const void *dst, const void *sampling, const void *paint); // (SkCanvas *canvas, sk_image_t image, const SkRect *dst, const SkSamplingOptions *sampling, const SkPaint *paint)
void SkCanvas_drawImageRect_2(reskia_canvas_t *canvas, int image, const void *src, const void *dst, const void *sampling, const void *paint, int constraint); // (SkCanvas *canvas, sk_image_t image, const SkRect *src, const SkRect *dst, const SkSamplingOptions *sampling, const SkPaint *paint, SkCanvas::SrcRectConstraint constraint)
...
void SkCanvas_drawLine(reskia_canvas_t *canvas, int p0, int p1, const void *paint); // (SkCanvas *canvas, sk_point_t p0, sk_point_t p1, const SkPaint *paint)
...
void SkCanvas_drawMesh(reskia_canvas_t *canvas, const void *mesh, int blender, const void *paint); // (SkCanvas *canvas, const SkMesh *mesh, sk_blender_t blender, const SkPaint *paint)
...
void SkCanvas_drawPicture(reskia_canvas_t *canvas, int picture); // (SkCanvas *canvas, sk_picture_t picture)
void SkCanvas_drawPicture_2(reskia_canvas_t *canvas, int picture, const void *matrix, const void *paint); // (SkCanvas *canvas, sk_picture_t picture, const SkMatrix *matrix, const SkPaint *paint)
...
void SkCanvas_drawPoint(reskia_canvas_t *canvas, int p, const void *paint); // (SkCanvas *canvas, sk_point_t p, const SkPaint *paint)
...
void SkCanvas_drawRect(reskia_canvas_t *canvas, int rect, const void *paint); // (SkCanvas *canvas, sk_rect_t rect, const SkPaint *paint)
...
void SkCanvas_drawTextBlob(reskia_canvas_t *canvas, int text_blob, float x, float y, const void *paint); // (SkCanvas *canvas, sk_text_blob_t text_blob, SkScalar x, SkScalar y, const SkPaint *paint)
...
void SkCanvas_drawVertices(reskia_canvas_t *canvas, int vertices, int mode, const void *paint); // (SkCanvas *canvas, sk_vertices_t vertices, SkBlendMode mode, const SkPaint *paint)
...
int SkCanvas_getBaseLayerSize(reskia_canvas_t *canvas); // (SkCanvas *canvas) -> sk_i_size_t
int SkCanvas_getBaseProps(reskia_canvas_t *canvas); // (SkCanvas *canvas) -> sk_surface_props_t
int SkCanvas_getDeviceClipBounds(reskia_canvas_t *canvas); // (SkCanvas *canvas) -> sk_i_rect_t
bool SkCanvas_getDeviceClipBounds_2(reskia_canvas_t *canvas, void *bounds); // (SkCanvas *canvas, SkIRect *bounds) -> bool
int SkCanvas_getLocalClipBounds(reskia_canvas_t *canvas); // (SkCanvas *canvas) -> sk_rect_t
bool SkCanvas_getLocalClipBounds_2(reskia_canvas_t *canvas, void *bounds); // (SkCanvas *canvas, SkRect *bounds) -> bool
int SkCanvas_getLocalToDevice(reskia_canvas_t *canvas); // (SkCanvas *canvas) -> sk_m_44_t
int SkCanvas_getLocalToDeviceAs3x3(reskia_canvas_t *canvas); // (SkCanvas *canvas) -> sk_matrix_t
...
int SkCanvas_getTopProps(reskia_canvas_t *canvas); // (SkCanvas *canvas) -> sk_surface_props_t
int SkCanvas_getTotalMatrix(reskia_canvas_t *canvas); // (SkCanvas *canvas) -> sk_matrix_t
int SkCanvas_imageInfo(reskia_canvas_t *canvas); // (SkCanvas *canvas) -> sk_image_info_t
...
int SkCanvas_makeSurface(reskia_canvas_t *canvas, const void *info, const void *props); // (SkCanvas *canvas, const SkImageInfo *info, const SkSurfaceProps *props) -> sk_surface_t
...
// static
int SkCanvas_MakeRasterDirect(const void *info, void *pixels, size_t rowBytes, const void *props); // (const SkImageInfo *info, void *pixels, size_t rowBytes, const SkSurfaceProps *props) -> sk_canvas_t
int SkCanvas_MakeRasterDirectN32(int width, int height, void *pixels, size_t rowBytes); // (int width, int height, SkPMColor *pixels, size_t rowBytes) -> sk_canvas_t}
