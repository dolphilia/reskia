...
void SkCanvas_clipPath_2(reskia_canvas_t *canvas, const void *path, reskia_canvas_clip_op_t op); // (SkCanvas *canvas, const SkPath *path, SkClipOp op)
void SkCanvas_clipPath_3(reskia_canvas_t *canvas, const void *path, reskia_canvas_clip_op_t op, bool doAntiAlias); // (SkCanvas *canvas, const SkPath *path, SkClipOp op, bool doAntiAlias)
...
void SkCanvas_clipRect_2(reskia_canvas_t *canvas, const void *rect, reskia_canvas_clip_op_t op); // (SkCanvas *canvas, const SkRect *rect, SkClipOp op)
void SkCanvas_clipRect_3(reskia_canvas_t *canvas, const void *rect, reskia_canvas_clip_op_t op, bool doAntiAlias); // (SkCanvas *canvas, const SkRect *rect, SkClipOp op, bool doAntiAlias)
...
void SkCanvas_clipRRect_2(reskia_canvas_t *canvas, const void *rrect, reskia_canvas_clip_op_t op); // (SkCanvas *canvas, const SkRRect *rrect, SkClipOp op)
void SkCanvas_clipRRect_3(reskia_canvas_t *canvas, const void *rrect, reskia_canvas_clip_op_t op, bool doAntiAlias); // (SkCanvas *canvas, const SkRRect *rrect, SkClipOp op, bool doAntiAlias)
...
void SkCanvas_drawColor_2(reskia_canvas_t *canvas, uint32_t color, reskia_blend_mode_t mode); // (SkCanvas *canvas, SkColor color, SkBlendMode mode)
...
void SkCanvas_drawImageLattice_2(reskia_canvas_t *canvas, const void *image, const void *lattice, const void *dst, reskia_canvas_filter_mode_t filter, const void *paint); // (SkCanvas *canvas, const SkImage *image, const SkCanvas::Lattice *lattice, const SkRect *dst, SkFilterMode filter, const SkPaint *paint)
...
void SkCanvas_drawVertices_2(reskia_canvas_t *canvas, const void *vertices, reskia_blend_mode_t mode, const void *paint); // (SkCanvas *canvas, const SkVertices *vertices, SkBlendMode mode, const SkPaint *paint)
...
void SkCanvas_experimental_DrawEdgeAAQuad_2(reskia_canvas_t *canvas, const void *rect, const void * clip, reskia_canvas_quad_aa_flags_t aaFlags, uint32_t color, reskia_blend_mode_t mode); // (SkCanvas *canvas, const SkRect *rect, const SkPoint clip[4], SkCanvas::QuadAAFlags aaFlags, SkColor color, SkBlendMode mode)
