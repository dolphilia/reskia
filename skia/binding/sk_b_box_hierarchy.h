...
void SkBBoxHierarchy_delete(void *b_box_hierarchy); // owned: caller が保持する参照を release する (SkBBoxHierarchy *b_box_hierarchy)
...
void SkBBoxHierarchy_ref(void *b_box_hierarchy); // retained: 参照カウントを増やす (SkBBoxHierarchy *b_box_hierarchy)
void SkBBoxHierarchy_unref(void *b_box_hierarchy); // owned: 参照カウントを減らす (SkBBoxHierarchy *b_box_hierarchy)
