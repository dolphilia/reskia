...
void SkSurface_delete(void *surface); // owned: caller が保持する参照を release する (SkSurface *surface)
...
void * SkSurface_recordingContext(void *surface); // borrowed: 解放不要の借用ポインタ (SkSurface *surface) -> GrRecordingContext *
void * SkSurface_recorder(void *surface); // borrowed: 解放不要の借用ポインタ (SkSurface *surface) -> skgpu::graphite::Recorder *
...
void * SkSurface_getCanvas(void *surface); // borrowed: 解放不要の借用ポインタ (SkSurface *surface) -> SkCanvas *
...
const void * SkSurface_props(void *surface); // borrowed: 解放不要の借用ポインタ (SkSurface *surface) -> const SkSurfaceProps *
...
void SkSurface_ref(void *surface); // retained: 参照カウントを増やす (SkSurface *surface)
void SkSurface_unref(void *surface); // owned: 参照カウントを減らす (SkSurface *surface)
