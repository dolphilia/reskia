...
int SkShader_makeWithLocalMatrix(reskia_shader_t *shader, const reskia_matrix_t *matrix); // (SkShader *shader, const SkMatrix *matrix) -> sk_shader_t
int SkShader_makeWithColorFilter(reskia_shader_t *shader, int color_filter); // (SkShader *shader, sk_color_filter_t color_filter) -> sk_shader_t
int SkShader_makeWithWorkingColorSpace(reskia_shader_t *shader, int color_space); // (SkShader *shader, sk_color_space_t color_space) -> sk_shader_t
int SkShader_getFactory(reskia_shader_t *shader); // (SkShader *shader) -> sk_flattenable_factory_t
...
int SkShader_getFlattenableType(reskia_shader_t *shader); // (SkShader *shader) -> SkShader::Type
int SkShader_serialize(reskia_shader_t *shader, const reskia_serial_procs_t *procs); // (SkShader *shader, const SkSerialProcs *procs) -> sk_data_t
...
int SkShader_Deserialize(int type, const void *data, size_t length, const reskia_deserial_procs_t *procs); // (SkShader::Type type, const void *data, size_t length, const SkDeserialProcs *procs) -> sk_flattenable_t
