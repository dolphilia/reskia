...
sk_image_filter_t SkImageFilters_Shader_2(sk_shader_t shader, reskia_image_filters_dither_t dither, const reskia_crop_rect_t *cropRect); // (sk_shader_t shader, SkImageFilters::Dither dither, const SkImageFilters::CropRect *cropRect) -> sk_image_filter_t
