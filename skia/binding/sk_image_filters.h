...
sk_image_filter_t SkImageFilters_Blend(int mode, sk_image_filter_t background, sk_image_filter_t foreground, const reskia_crop_rect_t *cropRect); // (SkBlendMode mode, sk_image_filter_t background, sk_image_filter_t foreground, const SkImageFilters::CropRect *cropRect) -> sk_image_filter_t
sk_image_filter_t SkImageFilters_Blend_2(reskia_blender_t blender, sk_image_filter_t background, sk_image_filter_t foreground, const reskia_crop_rect_t *cropRect); // (sk_blender_t blender, sk_image_filter_t background, sk_image_filter_t foreground, const SkImageFilters::CropRect *cropRect) -> sk_image_filter_t
sk_image_filter_t SkImageFilters_Blur(float sigmaX, float sigmaY, int tileMode, sk_image_filter_t input, const reskia_crop_rect_t *cropRect); // (SkScalar sigmaX, SkScalar sigmaY, SkTileMode tileMode, sk_image_filter_t input, const SkImageFilters::CropRect *cropRect) -> sk_image_filter_t
sk_image_filter_t SkImageFilters_Blur_2(float sigmaX, float sigmaY, sk_image_filter_t input, const reskia_crop_rect_t *cropRect); // (SkScalar sigmaX, SkScalar sigmaY, sk_image_filter_t input, const SkImageFilters::CropRect *cropRect) -> sk_image_filter_t
...
sk_image_filter_t SkImageFilters_Crop(const reskia_rect_t *rect, int tileMode, sk_image_filter_t input); // (const SkRect *rect, SkTileMode tileMode, sk_image_filter_t input) -> sk_image_filter_t
sk_image_filter_t SkImageFilters_Crop_2(const reskia_rect_t *rect, sk_image_filter_t input); // (const SkRect *rect, sk_image_filter_t input) -> sk_image_filter_t
sk_image_filter_t SkImageFilters_DisplacementMap(int xChannelSelector, int yChannelSelector, float scale, sk_image_filter_t displacement, sk_image_filter_t color, const reskia_crop_rect_t *cropRect); // (SkColorChannel xChannelSelector, SkColorChannel yChannelSelector, SkScalar scale, sk_image_filter_t displacement, sk_image_filter_t color, const SkImageFilters::CropRect *cropRect) -> sk_image_filter_t
...
sk_image_filter_t SkImageFilters_Image_2(sk_image_t image, const reskia_sampling_options_t *sampling); // (sk_image_t image, const SkSamplingOptions *sampling) -> sk_image_filter_t
...
sk_image_filter_t SkImageFilters_MatrixConvolution(const reskia_i_size_t *kernelSize, const float *kernel, float gain, float bias, const reskia_i_point_t *kernelOffset, int tileMode, bool convolveAlpha, sk_image_filter_t input, const reskia_crop_rect_t *cropRect); // (const SkISize *kernelSize, const SkScalar kernel[], SkScalar gain, SkScalar bias, const SkIPoint *kernelOffset, SkTileMode tileMode, bool convolveAlpha, sk_image_filter_t input, const SkImageFilters::CropRect *cropRect) -> sk_image_filter_t
...
sk_image_filter_t SkImageFilters_Merge_2(sk_image_filter_t first, sk_image_filter_t second, const reskia_crop_rect_t *cropRect); // (sk_image_filter_t first, sk_image_filter_t second, const SkImageFilters::CropRect *cropRect) -> sk_image_filter_t
...
sk_image_filter_t SkImageFilters_Picture_2(sk_picture_t picture); // (sk_picture_t picture) -> sk_image_filter_t
...
sk_image_filter_t SkImageFilters_RuntimeShader_2(const reskia_runtime_shader_builder_t *builder, float sampleRadius, reskia_string_view_t childShaderName, sk_image_filter_t input); // (const SkRuntimeShaderBuilder *builder, SkScalar sampleRadius, string_view_t childShaderName, sk_image_filter_t input) -> sk_image_filter_t
sk_image_filter_t SkImageFilters_RuntimeShader_3(const reskia_runtime_shader_builder_t *builder, reskia_string_view_t *childShaderNames, const reskia_image_filter_sp_t *inputs, int inputCount); // (const SkRuntimeShaderBuilder *builder, std::string_view childShaderNames[], const sk_sp<SkImageFilter> *inputs, int inputCount) -> sk_image_filter_t
sk_image_filter_t SkImageFilters_RuntimeShader_4(const reskia_runtime_shader_builder_t *builder, float maxSampleRadius, reskia_string_view_t *childShaderNames, const reskia_image_filter_sp_t *inputs, int inputCount); // (const SkRuntimeShaderBuilder *builder, SkScalar maxSampleRadius, std::string_view childShaderNames[], const sk_sp<SkImageFilter> *inputs, int inputCount) -> sk_image_filter_t
...
sk_image_filter_t SkImageFilters_Shader_2(sk_shader_t shader, int dither, const reskia_crop_rect_t *cropRect); // (sk_shader_t shader, SkImageFilters::Dither dither, const SkImageFilters::CropRect *cropRect) -> sk_image_filter_t
