...
void SkOpBuilder_add(reskia_op_builder_t *op_builder, const reskia_path_t *path, int path_operator); // // (SkOpBuilder *op_builder, const SkPath *path, SkPathOp path_operator)
