...
int SkImageFilter_filterBounds(reskia_image_filter_t *image_filter, const reskia_i_rect_t *src, const reskia_matrix_t *ctm, int direction, const reskia_i_rect_t *inputRect); // (SkImageFilter *image_filter, const SkIRect *src, const SkMatrix *ctm, SkImageFilter::MapDirection direction, const SkIRect *inputRect) -> sk_i_rect_t
...
int SkImageFilter_computeFastBounds(reskia_image_filter_t *image_filter, const reskia_rect_t *bounds); // (SkImageFilter *image_filter, const SkRect *bounds) -> sk_rect_t
bool SkImageFilter_canComputeFastBounds(reskia_image_filter_t *image_filter); // (SkImageFilter *image_filter) -> bool
int SkImageFilter_makeWithLocalMatrix(reskia_image_filter_t *image_filter, const reskia_matrix_t *matrix); // (SkImageFilter *image_filter, const SkMatrix *matrix) -> sk_image_filter_t
int SkImageFilter_getFactory(reskia_image_filter_t *image_filter); // (SkImageFilter *image_filter) -> sk_flattenable_factory_t
...
int SkImageFilter_getFlattenableType(reskia_image_filter_t *image_filter); // (SkImageFilter *image_filter) -> SkImageFilter::Type
int SkImageFilter_serialize(reskia_image_filter_t *image_filter, const reskia_serial_procs_t *procs); // (SkImageFilter *image_filter, const SkSerialProcs *procs) -> sk_data_t
...
int SkImageFilter_Deserialize(const void *data, size_t size, const reskia_deserial_procs_t *procs); // (const void *data, size_t size, const SkDeserialProcs *procs) -> sk_image_filter_t
