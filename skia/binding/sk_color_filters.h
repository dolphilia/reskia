...
int SkColorFilters_Blend(const reskia_color_4f_t *c, int color_space, int mode); // (const SkColor4f *c, sk_color_space_t color_space, SkBlendMode mode) -> sk_color_filter_t
int SkColorFilters_Blend_2(reskia_color_t c, int mode); // (SkColor c, SkBlendMode mode) -> sk_color_filter_t
...
int SkColorFilters_HSLAMatrix_2(const reskia_color_matrix_t *matrix); // (const SkColorMatrix *matrix) -> sk_color_filter_t
...
int SkColorFilters_Lighting(reskia_color_t mul, reskia_color_t add); // (SkColor mul, SkColor add) -> sk_color_filter_t
...
int SkColorFilters_Matrix_2(const reskia_color_matrix_t *matrix); // (const SkColorMatrix *matrix) -> sk_color_filter_t
int SkColorFilters_SRGBToLinearGamma(); // () -> sk_color_filter_t
int SkColorFilters_Table(const uint8_t table[256]); // (const uint8_t table[256]) -> sk_color_filter_t
