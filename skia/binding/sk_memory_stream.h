...
reskia_memory_stream_t *SkMemoryStream_new_4(int data); // (sk_data_t data) -> SkMemoryStream *
...
int SkMemoryStream_asData(reskia_memory_stream_t *memory_stream); // (SkMemoryStream *memory_stream) -> sk_data_t
void SkMemoryStream_setData(reskia_memory_stream_t *memory_stream, int data); // (SkMemoryStream *memory_stream, sk_data_t data)
...
int SkMemoryStream_duplicate(reskia_memory_stream_t *memory_stream); // (SkMemoryStream *memory_stream) -> sk_memory_stream_t
...
int SkMemoryStream_fork(reskia_memory_stream_t *memory_stream); // (SkMemoryStream *memory_stream) -> sk_memory_stream_t
...
int SkMemoryStream_MakeCopy(const uint8_t *data, size_t length); // (const void *data, size_t length) -> sk_memory_stream_t
int SkMemoryStream_MakeDirect(const uint8_t *data, size_t length); // (const void *data, size_t length) -> sk_memory_stream_t
