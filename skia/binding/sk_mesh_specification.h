...
int SkMeshSpecification_attributes(reskia_mesh_specification_t* spec); // (SkMeshSpecification* spec) -> sk_mesh_specification_attribute_t
...
int SkMeshSpecification_Make_2(reskia_mesh_specification_attribute_span_t * attributes, size_t vertexStride, reskia_mesh_specification_varying_span_t * varyings, const reskia_string_t * vs, const reskia_string_t * fs, reskia_color_space_sp_t * cs); // (SkSpan<const SkMeshSpecification::Attribute>* attributes, size_t vertexStride, SkSpan<const SkMeshSpecification::Varying>* varyings, const SkString* vs, const SkString* fs, sk_sp<SkColorSpace>* cs) -> sk_mesh_specification_result_t
int SkMeshSpecification_Make_3(reskia_mesh_specification_attribute_span_t * attributes, size_t vertexStride, reskia_mesh_specification_varying_span_t * varyings, const reskia_string_t * vs, const reskia_string_t * fs, reskia_color_space_sp_t * cs, int at); // (SkSpan<const SkMeshSpecification::Attribute>* attributes, size_t vertexStride, SkSpan<const SkMeshSpecification::Varying>* varyings, const SkString* vs, const SkString* fs, sk_sp<SkColorSpace>* cs, SkAlphaType at) -> sk_mesh_specification_result_t
