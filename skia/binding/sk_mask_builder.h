...
reskia_mask_builder_t *SkMaskBuilder_new_2(uint8_t *img, const reskia_i_rect_t *bounds, uint32_t rowBytes, int format); // (uint8_t* img, const SkIRect * bounds, uint32_t rowBytes, SkMask::Format format) -> SkMaskBuilder *
...
int SkMaskBuilder_format(reskia_mask_builder_t *maskBuilder); // (SkMaskBuilder *maskBuilder) -> SkMask::Format
