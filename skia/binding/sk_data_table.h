...
int SkDataTable_MakeCopyArrays(const uint8_t * const *ptrs, const size_t *sizes, int count); // (const void *const *ptrs, const size_t sizes[], int count) -> sk_data_table_t
int SkDataTable_MakeCopyArray(const uint8_t *array, size_t elemSize, int count); // (const void *array, size_t elemSize, int count) -> sk_data_table_t
int SkDataTable_MakeArrayProc(const uint8_t *array, size_t elemSize, int count, void (*proc)(void*), void *context); // (const void *array, size_t elemSize, int count, SkDataTable::FreeProc proc, void *context) -> sk_data_table_t
