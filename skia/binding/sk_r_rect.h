...
int SkRRect_getSimpleRadii(reskia_r_rect_t *rrect); // (SkRRect *rrect) -> sk_point_t
...
int SkRRect_radii(reskia_r_rect_t *rrect, int corner); // (SkRRect *rrect, SkRRect::Corner corner) -> sk_point_t
...
int SkRRect_makeOffset(reskia_r_rect_t *rrect, float dx, float dy); // (SkRRect *rrect, SkScalar dx, SkScalar dy) -> sk_r_rect_t
...
int SkRRect_dumpToString(reskia_r_rect_t *rrect, bool asHex); // (SkRRect *rrect, bool asHex) -> sk_string_t
...
int SkRRect_MakeRect(const reskia_rect_t *r); // (const SkRect *r) -> sk_r_rect_t
int SkRRect_MakeOval(const reskia_rect_t *oval); // (const SkRect *oval) -> sk_r_rect_t
int SkRRect_MakeRectXY(const reskia_rect_t *rect, float xRad, float yRad); // (const SkRect *rect, SkScalar xRad, SkScalar yRad) -> sk_r_rect_t
