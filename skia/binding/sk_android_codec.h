...
int SkAndroidCodec_MakeFromCodec(sk_codec_t codec); // -> sk_android_codec_t
int SkAndroidCodec_MakeFromStream(sk_codec_t codec, SkPngChunkReader* pngChunkReader); // -> sk_android_codec_t
int SkAndroidCodec_MakeFromData(sk_codec_t codec, SkPngChunkReader* pngChunkReader); // -> sk_android_codec_t
