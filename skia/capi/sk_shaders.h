...
sk_shader_t SkShaders_ColorWithColor4fAndColorSpace(const reskia_color_4f_t *color4f, sk_color_space_t color_space); // (const SkColor4f *color4f, sk_color_space_t color_space) -> sk_shader_t
...
sk_shader_t SkShaders_BlendWithBlender(reskia_blender_t value, sk_shader_t dst, sk_shader_t src); // (sk_blender_t value, sk_shader_t dst, sk_shader_t src) -> sk_shader_t
