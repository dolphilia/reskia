...
#include "../handles/static_sk_stream_memory.h"
#include "../handles/static_sk_stream_asset.h"

#include "../handles/static_sk_stream_asset-internal.h"
#include "../handles/static_sk_stream_memory-internal.h"
...
size_t SkStreamMemory_peek(reskia_stream_memory_t *stream_memory, void *buffer, size_t size) {
    if (stream_memory == nullptr || (buffer == nullptr && size > 0)) {
        return 0;
    }
...
bool SkStreamMemory_readS8(reskia_stream_memory_t *stream_memory, int8_t *i) {
    if (stream_memory == nullptr || i == nullptr) {
        return false;
    }
...
bool SkStreamMemory_readBool(reskia_stream_memory_t *stream_memory, bool *b) {
    if (stream_memory == nullptr || b == nullptr) {
        return false;
    }
...
bool SkStreamMemory_readScalar(reskia_stream_memory_t *stream_memory, float *v) {
    if (stream_memory == nullptr || v == nullptr) {
        return false;
    }
...
bool SkStreamMemory_readPackedUInt(reskia_stream_memory_t *stream_memory, size_t *size) {
    if (stream_memory == nullptr || size == nullptr) {
        return false;
    }
