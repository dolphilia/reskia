...
/**
 * NULL 入力では no-op (SkColorMatrix *color_matrix, float rScale, float gScale, float bScale, float aScale)
 */
void SkColorMatrix_setScale(reskia_color_matrix_t *color_matrix, float rScale, float gScale, float bScale, float aScale);
/**
 * NULL 入力では no-op (SkColorMatrix *color_matrix, float dr, float dg, float db, float da)
 */
void SkColorMatrix_postTranslate(reskia_color_matrix_t *color_matrix, float dr, float dg, float db, float da);
/**
 * color_matrix/a/b は非 NULL。NULL 入力では no-op (SkColorMatrix *color_matrix, const SkColorMatrix *a, const SkColorMatrix *b)
 */
...
/**
 * color_matrix/mat は非 NULL。NULL 入力では no-op (SkColorMatrix *color_matrix, const SkColorMatrix *mat)
 */
