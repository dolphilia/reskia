...
/**
 * canvas は非 NULL、matrix は NULL 許可。invalid 入力では no-op
 */
...
/**
 * matrix/clipBounds/bufferInfo は非 NULL。invalid 入力や生成不能では 0
 */
...
/**
 * memory_size > 0 では memory 非 NULL。invalid 入力では 0
 */
