...
sk_matrix_t SkMatrix_set(reskia_matrix_t *matrix, int index, float value); // (SkMatrix *matrix, int index, SkScalar value) -> sk_matrix_t
...
sk_matrix_t SkMatrix_set9(reskia_matrix_t *matrix, const float *buffer); // (SkMatrix *matrix, const SkScalar buffer[9]) -> sk_matrix_t
...
sk_matrix_t SkMatrix_setTranslate_2(reskia_matrix_t *matrix, const reskia_vector_t *v); // (SkMatrix *matrix, const SkVector *v) -> sk_matrix_t
...
sk_matrix_t SkMatrix_setScale_2(reskia_matrix_t *matrix, float sx, float sy); // (SkMatrix *matrix, SkScalar sx, SkScalar sy) -> sk_matrix_t
...
sk_matrix_t SkMatrix_setRotate_2(reskia_matrix_t *matrix, float degrees); // (SkMatrix *matrix, SkScalar degrees) -> sk_matrix_t
...
sk_matrix_t SkMatrix_setSinCos_2(reskia_matrix_t *matrix, float sinValue, float cosValue); // (SkMatrix *matrix, SkScalar sinValue, SkScalar cosValue) -> sk_matrix_t
sk_matrix_t SkMatrix_setRSXform(reskia_matrix_t *matrix, const reskia_rsxform_t *rsxForm); // (SkMatrix *matrix, const SkRSXform *rsxForm) -> sk_matrix_t
...
sk_matrix_t SkMatrix_setSkew_2(reskia_matrix_t *matrix, float kx, float ky); // (SkMatrix *matrix, SkScalar kx, SkScalar ky) -> sk_matrix_t
sk_matrix_t SkMatrix_setConcat(reskia_matrix_t *matrix, const reskia_matrix_t *a, const reskia_matrix_t *b); // (SkMatrix *matrix, const SkMatrix *a, const SkMatrix *b) -> sk_matrix_t
...
sk_matrix_t SkMatrix_preScale_2(reskia_matrix_t *matrix, float sx, float sy); // (SkMatrix *matrix, SkScalar sx, SkScalar sy) -> sk_matrix_t
...
sk_matrix_t SkMatrix_preRotate_2(reskia_matrix_t *matrix, float degrees); // (SkMatrix *matrix, SkScalar degrees) -> sk_matrix_t
...
sk_matrix_t SkMatrix_preSkew_2(reskia_matrix_t *matrix, float kx, float ky); // (SkMatrix *matrix, SkScalar kx, SkScalar ky) -> sk_matrix_t
sk_matrix_t SkMatrix_preConcat(reskia_matrix_t *matrix, const reskia_matrix_t *other); // (SkMatrix *matrix, const SkMatrix *other) -> sk_matrix_t
...
sk_matrix_t SkMatrix_postScale_2(reskia_matrix_t *matrix, float sx, float sy); // (SkMatrix *matrix, SkScalar sx, SkScalar sy) -> sk_matrix_t
...
sk_matrix_t SkMatrix_postRotate_2(reskia_matrix_t *matrix, float degrees); // (SkMatrix *matrix, SkScalar degrees) -> sk_matrix_t
...
sk_matrix_t SkMatrix_setAffine(reskia_matrix_t *matrix, const float *affine); // (SkMatrix *matrix, const SkScalar affine[6]) -> sk_matrix_t
...
sk_point_t SkMatrix_mapXY_2(reskia_matrix_t *matrix, float x, float y); // (SkMatrix *matrix, SkScalar x, SkScalar y) -> sk_point_t
...
sk_matrix_t SkMatrix_Translate_2(sk_point_t t); // (sk_point_t t) -> sk_matrix_t
sk_matrix_t SkMatrix_Translate_3(sk_i_point_t t); // (sk_i_point_t t) -> sk_matrix_t
...
sk_matrix_t SkMatrix_Concat(const reskia_matrix_t *a, const reskia_matrix_t *b); // (const SkMatrix *a, const SkMatrix *b) -> sk_matrix_t
