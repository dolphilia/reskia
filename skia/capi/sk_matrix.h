...
sk_matrix_t SkMatrix_setTranslateWithVector(reskia_matrix_t *matrix, const reskia_vector_t *v); // (SkMatrix *matrix, const SkVector *v) -> sk_matrix_t
...
void SkMatrix_mapPointsInPlace(reskia_matrix_t *matrix, reskia_point_t *pts, int count); // (SkMatrix *matrix, SkPoint pts[], int count)
...
void SkMatrix_mapHomogeneousPointsFromPoints(reskia_matrix_t *matrix, reskia_point3_t *dst, const reskia_point_t *src, int count); // (SkMatrix *matrix, SkPoint3 dst[], const SkPoint src[], int count)
...
void SkMatrix_mapVectorsInPlace(reskia_matrix_t *matrix, reskia_vector_t *vecs, int count); // (SkMatrix *matrix, SkVector vecs[], int count)
...
bool SkMatrix_mapRectInPlace(reskia_matrix_t *matrix, reskia_rect_t *rect, reskia_matrix_apply_perspective_clip_t pc); // (SkMatrix *matrix, SkRect *rect, SkApplyPerspectiveClip pc) -> bool
sk_rect_t SkMatrix_mapRectFromSource(reskia_matrix_t *matrix, const reskia_rect_t *src, reskia_matrix_apply_perspective_clip_t pc); // (SkMatrix *matrix, const SkRect *src, SkApplyPerspectiveClip pc) -> sk_rect_t
