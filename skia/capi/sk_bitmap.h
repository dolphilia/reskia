...
reskia_bitmap_t *SkBitmap_new_copy(const reskia_bitmap_t *src); // (const SkBitmap *src) -> SkBitmap *
...
void SkBitmap_allocPixels_withAllocator(reskia_bitmap_t *bitmap, reskia_bitmap_allocator_t *allocator); // (SkBitmap *bitmap, SkBitmap::Allocator *allocator)
void SkBitmap_allocPixels_withInfo(reskia_bitmap_t *bitmap, const reskia_image_info_t *info); // (SkBitmap *bitmap, const SkImageInfo *info)
void SkBitmap_allocPixels_withInfoRowBytes(reskia_bitmap_t *bitmap, const reskia_image_info_t *info, size_t rowBytes); // (SkBitmap *bitmap, const SkImageInfo *info, size_t rowBytes)
...
void SkBitmap_eraseColor4fInArea(reskia_bitmap_t *bitmap, sk_color_4f_t c, const reskia_i_rect_t *area); // (SkBitmap *bitmap, sk_color_4f_t c, const SkIRect *area)
...
void SkBitmap_eraseColor4f(reskia_bitmap_t *bitmap, sk_color_4f_t c); // (SkBitmap *bitmap, sk_color_4f_t c)
...
bool SkBitmap_installPixels_withReleaseProc(reskia_bitmap_t *bitmap, const reskia_image_info_t *info, void *pixels, size_t rowBytes, void(*releaseProc)(void *addr, void *context), void *context); // (SkBitmap *bitmap, const SkImageInfo *info, void *pixels, size_t rowBytes, void(*releaseProc)(void *addr, void *context), void *context) -> bool
...
sk_shader_t SkBitmap_makeShader_withOptionalLocalMatrix(reskia_bitmap_t *bitmap, const reskia_sampling_options_t *sampling, const reskia_matrix_t *lm); // (SkBitmap *bitmap, const SkSamplingOptions *sampling, const SkMatrix *lm) -> sk_shader_t
sk_shader_t SkBitmap_makeShader_withTileModesOptionalLocalMatrix(reskia_bitmap_t *bitmap, reskia_bitmap_tile_mode_t tmx, reskia_bitmap_tile_mode_t tmy, const reskia_sampling_options_t *sampling, const reskia_matrix_t *localMatrix); // (SkBitmap *bitmap, SkTileMode tmx, SkTileMode tmy, const SkSamplingOptions *sampling, const SkMatrix *localMatrix) -> sk_shader_t
sk_shader_t SkBitmap_makeShader_withTileModesLocalMatrix(reskia_bitmap_t *bitmap, reskia_bitmap_tile_mode_t tmx, reskia_bitmap_tile_mode_t tmy, const reskia_sampling_options_t *sampling, const reskia_matrix_t *lm); // (SkBitmap *bitmap, SkTileMode tmx, SkTileMode tmy, const SkSamplingOptions *sampling, const SkMatrix *lm) -> sk_shader_t
...
bool SkBitmap_tryAllocPixels_withAllocator(reskia_bitmap_t *bitmap, reskia_bitmap_allocator_t *allocator); // (SkBitmap *bitmap, SkBitmap::Allocator *allocator) -> bool
bool SkBitmap_tryAllocPixels_withInfo(reskia_bitmap_t *bitmap, const reskia_image_info_t *info); // (SkBitmap *bitmap, const SkImageInfo *info) -> bool
bool SkBitmap_tryAllocPixels_withInfoRowBytes(reskia_bitmap_t *bitmap, const reskia_image_info_t *info, size_t rowBytes); // (SkBitmap *bitmap, const SkImageInfo *info, size_t rowBytes) -> bool
...
bool SkBitmap_writePixels_withDstOffset(reskia_bitmap_t *bitmap, const reskia_pixmap_t *src, int dstX, int dstY); // (SkBitmap *bitmap, const SkPixmap *src, int dstX, int dstY) -> bool
// static
