...
sk_mask_filter_t SkMaskFilter_MakeBlur(reskia_mask_filter_blur_style_t style, float sigma, bool respectCTM); // (SkBlurStyle style, SkScalar sigma, bool respectCTM) -> sk_mask_filter_t
