...
/**
 * canvas, image, src, dst, and sampling must be non-NULL. paint may be NULL.
 * No-op for invalid input.
 * (SkCanvas *canvas, const SkImage *image, const SkRect *src, const SkRect *dst, const SkSamplingOptions *sampling, const SkPaint *paint, SkCanvas::SrcRectConstraint constraint)
 */
 ...
 * canvas, image, src, dst, and sampling must be non-NULL. paint may be NULL.
 * No-op for invalid input.
 * (SkCanvas *canvas, const sk_sp< SkImage > *image, const SkRect *src, const SkRect *dst, const SkSamplingOptions *sampling, const SkPaint *paint, SkCanvas::SrcRectConstraint constraint)
 */
...
/**
 * canvas, image, dst, and sampling must be non-NULL. paint may be NULL.
 * No-op for invalid input.
 * (SkCanvas *canvas, const SkImage *image, const SkRect *dst, const SkSamplingOptions *sampling, const SkPaint *paint, SkCanvas::SrcRectConstraint constraint)
 */
 ...
 * canvas, image, dst, and sampling must be non-NULL. paint may be NULL.
 * No-op for invalid input.
 * (SkCanvas *canvas, const sk_sp< SkImage > *image, const SkRect *dst, const SkSamplingOptions *sampling, const SkPaint *paint, SkCanvas::SrcRectConstraint constraint)
 */
...
/**
 * canvas, image, and sampling must be non-NULL. paint may be NULL.
 * No-op for invalid input.
 * (SkCanvas *canvas, const SkImage *image, SkScalar x, SkScalar y, const SkSamplingOptions *sampling, const SkPaint *paint, SkCanvas::SrcRectConstraint constraint)
 */
 ...
 * canvas, image, and sampling must be non-NULL. paint may be NULL.
 * No-op for invalid input.
 * (SkCanvas *canvas, const sk_sp< SkImage > *image, SkScalar x, SkScalar y, const SkSamplingOptions *sampling, const SkPaint *paint, SkCanvas::SrcRectConstraint constraint)
 */
...
/**
 * image and keyValues may be NULL. NULL image fills keyValues with 0; NULL keyValues is a no-op.
 * (const SkImage *image, uint32_t keyValues[SkTiledImageUtils::kNumImageKeyValues])
 */
