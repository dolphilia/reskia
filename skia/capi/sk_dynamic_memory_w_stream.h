...
bool SkDynamicMemoryWStream_writeText(reskia_dynamic_memory_w_stream_t *dynamic_memory_w_stream, const char text[]); // text: non-null C string
...
bool SkDynamicMemoryWStream_writeStream(reskia_dynamic_memory_w_stream_t *dynamic_memory_w_stream, reskia_stream_t *input, size_t length); // input may be null only when length == 0
