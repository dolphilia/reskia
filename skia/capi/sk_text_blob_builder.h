...
const reskia_text_blob_builder_run_buffer_t *SkTextBlobBuilder_allocRunText(reskia_text_blob_builder_t *text_blob_builder, const reskia_font_t *font, int count, float x, float y, int textByteCount, const reskia_rect_t *bounds); // builder/font required; count > 0 and textByteCount >= 0; bounds may be NULL.
const reskia_text_blob_builder_run_buffer_t *SkTextBlobBuilder_allocRunTextPosH(reskia_text_blob_builder_t *text_blob_builder, const reskia_font_t *font, int count, float y, int textByteCount, const reskia_rect_t *bounds); // builder/font required; count > 0 and textByteCount >= 0; bounds may be NULL.
const reskia_text_blob_builder_run_buffer_t *SkTextBlobBuilder_allocRunTextPos(reskia_text_blob_builder_t *text_blob_builder, const reskia_font_t *font, int count, int textByteCount, const reskia_rect_t *bounds); // builder/font required; count > 0 and textByteCount >= 0; bounds may be NULL.
const reskia_text_blob_builder_run_buffer_t *SkTextBlobBuilder_allocRunTextRSXform(reskia_text_blob_builder_t *text_blob_builder, const reskia_font_t *font, int count, int textByteCount, const reskia_rect_t *bounds); // builder/font required; count > 0 and textByteCount >= 0; bounds may be NULL.
