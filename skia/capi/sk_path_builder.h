...
reskia_path_builder_t *SkPathBuilder_newCopy(const reskia_path_builder_t *builder); // builder は非 NULL。NULL なら NULL (const SkPathBuilder *builder) -> SkPathBuilder *
void SkPathBuilder_delete(reskia_path_builder_t *path_builder); // NULL path_builder は no-op (SkPathBuilder *path_builder)
reskia_path_builder_fill_type_t SkPathBuilder_fillType(reskia_path_builder_t *path_builder); // NULL path_builder なら 0 (SkPathBuilder *path_builder) -> SkPathFillType
...
reskia_path_builder_t *SkPathBuilder_setFillType(reskia_path_builder_t *path_builder, int ft); // NULL path_builder なら NULL (SkPathBuilder *path_builder, SkPathFillType ft) -> SkPathBuilder *
reskia_path_builder_t *SkPathBuilder_setIsVolatile(reskia_path_builder_t *path_builder, bool isVolatile); // NULL path_builder なら NULL (SkPathBuilder *path_builder, bool isVolatile) -> SkPathBuilder *
...
reskia_path_builder_t *SkPathBuilder_quadToPointArray(reskia_path_builder_t *path_builder, const reskia_point_t *pts); // pts は非 NULL。NULL pts は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const SkPoint pts[2]) -> SkPathBuilder *
...
reskia_path_builder_t *SkPathBuilder_conicToPointArray(reskia_path_builder_t *path_builder, const reskia_point_t *pts, float w); // pts は非 NULL。NULL pts は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const SkPoint pts[2], SkScalar w) -> SkPathBuilder *
...
reskia_path_builder_t *SkPathBuilder_cubicToPointArray(reskia_path_builder_t *path_builder, const reskia_point_t *pts); // pts は非 NULL。NULL pts は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const SkPoint pts[3]) -> SkPathBuilder *
reskia_path_builder_t *SkPathBuilder_close(reskia_path_builder_t *path_builder); // (SkPathBuilder *path_builder) -> SkPathBuilder *
reskia_path_builder_t *SkPathBuilder_polylineTo(reskia_path_builder_t *path_builder, const reskia_point_t *pts, int count); // pts は非 NULL かつ count > 0。invalid 入力は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const SkPoint pts[], int count) -> SkPathBuilder *
reskia_path_builder_t *SkPathBuilder_polylineToFromList(reskia_path_builder_t *path_builder, const void *list); // list は非 NULL。NULL list は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const std::initializer_list<SkPoint> *list) -> SkPathBuilder *
...
reskia_path_builder_t *SkPathBuilder_arcTo(reskia_path_builder_t *path_builder, const reskia_rect_t *oval, float startAngleDeg, float sweepAngleDeg, bool forceMoveTo); // oval は非 NULL。NULL oval は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const SkRect *oval, SkScalar startAngleDeg, SkScalar sweepAngleDeg, bool forceMoveTo) -> SkPathBuilder *
...
reskia_path_builder_t *SkPathBuilder_addArc(reskia_path_builder_t *path_builder, const reskia_rect_t *oval, float startAngleDeg, float sweepAngleDeg); // oval は非 NULL。NULL oval は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const SkRect *oval, SkScalar startAngleDeg, SkScalar sweepAngleDeg) -> SkPathBuilder *
reskia_path_builder_t *SkPathBuilder_addRect(reskia_path_builder_t *path_builder, const reskia_rect_t *rect, int dir, unsigned startIndex); // rect は非 NULL。NULL rect は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const SkRect *rect, SkPathDirection dir, unsigned startIndex) -> SkPathBuilder *
reskia_path_builder_t *SkPathBuilder_addRectWithDirection(reskia_path_builder_t *path_builder, const reskia_rect_t *rect, int dir); // rect は非 NULL。NULL rect は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const SkRect *rect, SkPathDirection dir) -> SkPathBuilder *
reskia_path_builder_t *SkPathBuilder_addOval(reskia_path_builder_t *path_builder, const reskia_rect_t *rect, int dir, unsigned startIndex); // rect は非 NULL。NULL rect は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const SkRect *rect, SkPathDirection dir, unsigned startIndex) -> SkPathBuilder *
reskia_path_builder_t *SkPathBuilder_addOvalWithDirection(reskia_path_builder_t *path_builder, const reskia_rect_t *rect, int dir); // rect は非 NULL。NULL rect は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const SkRect *rect, SkPathDirection dir) -> SkPathBuilder *
reskia_path_builder_t *SkPathBuilder_addRRect(reskia_path_builder_t *path_builder, const reskia_r_rect_t *rect, int dir, unsigned startIndex); // rect は非 NULL。NULL rect は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const SkRRect *rect, SkPathDirection dir, unsigned startIndex) -> SkPathBuilder *
reskia_path_builder_t *SkPathBuilder_addRRectWithDirection(reskia_path_builder_t *path_builder, const reskia_r_rect_t *rrect, int dir); // rrect は非 NULL。NULL rrect は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const SkRRect *rrect, SkPathDirection dir) -> SkPathBuilder *
...
reskia_path_builder_t *SkPathBuilder_addPolygon(reskia_path_builder_t *path_builder, const reskia_point_t *pts, int count, bool isClosed); // pts は非 NULL かつ count > 0。invalid 入力は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const SkPoint pts[], int count, bool isClosed) -> SkPathBuilder *
reskia_path_builder_t *SkPathBuilder_addPolygonFromList(reskia_path_builder_t *path_builder, const void *list, bool isClosed); // list は非 NULL。NULL list は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const std::initializer_list<SkPoint> *list, bool isClosed) -> SkPathBuilder *
reskia_path_builder_t *SkPathBuilder_addPath(reskia_path_builder_t *path_builder, const reskia_path_t *path); // path は非 NULL。NULL path は no-op、NULL path_builder なら NULL (SkPathBuilder *path_builder, const SkPath *path) -> SkPathBuilder *
void SkPathBuilder_incReserve(reskia_path_builder_t *path_builder, int extraPtCount, int extraVerbCount); // NULL path_builder は no-op (SkPathBuilder *path_builder, int extraPtCount, int extraVerbCount)
void SkPathBuilder_incReservePoints(reskia_path_builder_t *path_builder, int extraPtCount); // NULL path_builder は no-op (SkPathBuilder *path_builder, int extraPtCount)
