...
reskia_path_builder_t *SkPathBuilder_newFromPath(const reskia_path_t *path); // path must be non-NULL. Returns NULL for NULL input. (const SkPath *path) -> SkPathBuilder *
/**
 * builder must be non-NULL. Returns NULL for NULL input.
 * (const SkPathBuilder *builder) -> SkPathBuilder *
 */
reskia_path_builder_t *SkPathBuilder_newCopy(const reskia_path_builder_t *builder);
void SkPathBuilder_delete(reskia_path_builder_t *path_builder); // No-op when path_builder is NULL. (SkPathBuilder *path_builder)
...
/**
 * Returns 0 when path_builder is NULL.
 * (SkPathBuilder *path_builder) -> SkPathFillType
 */
reskia_path_builder_fill_type_t SkPathBuilder_fillType(reskia_path_builder_t *path_builder);
sk_rect_t SkPathBuilder_computeBounds(reskia_path_builder_t *path_builder); // Returns 0 when path_builder is NULL. (SkPathBuilder *path_builder) -> sk_rect_t
...
sk_path_t SkPathBuilder_snapshot(reskia_path_builder_t *path_builder); // Returns 0 when path_builder is NULL. (SkPathBuilder *path_builder) -> sk_path_t
sk_path_t SkPathBuilder_detach(reskia_path_builder_t *path_builder); // Returns 0 when path_builder is NULL. (SkPathBuilder *path_builder) -> sk_path_t
/**
 * Returns NULL when path_builder is NULL.
 * (SkPathBuilder *path_builder, SkPathFillType ft) -> SkPathBuilder *
 */
reskia_path_builder_t *SkPathBuilder_setFillType(reskia_path_builder_t *path_builder, int ft);
/**
 * Returns NULL when path_builder is NULL.
 * (SkPathBuilder *path_builder, bool isVolatile) -> SkPathBuilder *
 */
reskia_path_builder_t *SkPathBuilder_setIsVolatile(reskia_path_builder_t *path_builder, bool isVolatile);
reskia_path_builder_t *SkPathBuilder_reset(reskia_path_builder_t *path_builder); // Returns NULL when path_builder is NULL. (SkPathBuilder *path_builder) -> SkPathBuilder *
...
/**
 * pts must be non-NULL. NULL pts is no-op; NULL path_builder returns NULL.
 * (SkPathBuilder *path_builder, const SkPoint pts[2]) -> SkPathBuilder *
 */
...
/**
 * pts must be non-NULL. NULL pts is no-op; NULL path_builder returns NULL.
 * (SkPathBuilder *path_builder, const SkPoint pts[2], SkScalar w) -> SkPathBuilder *
 */
...
/**
 * pts must be non-NULL. NULL pts is no-op; NULL path_builder returns NULL.
 * (SkPathBuilder *path_builder, const SkPoint pts[3]) -> SkPathBuilder *
 */
...
/**
 * pts must be non-NULL and count must be greater than 0. Invalid input is no-op; NULL path_builder returns NULL.
 * (SkPathBuilder *path_builder, const SkPoint pts[], int count) -> SkPathBuilder *
 */
reskia_path_builder_t *SkPathBuilder_polylineTo(reskia_path_builder_t *path_builder, const reskia_point_t *pts, int count);
/**
 * list must be non-NULL. NULL list is no-op; NULL path_builder returns NULL.
 * (SkPathBuilder *path_builder, const std::initializer_list<SkPoint> *list) -> SkPathBuilder *
 */
...
/**
 * oval must be non-NULL. NULL oval is no-op; NULL path_builder returns NULL.
 * (SkPathBuilder *path_builder, const SkRect *oval, SkScalar startAngleDeg, SkScalar sweepAngleDeg, bool forceMoveTo) -> SkPathBuilder *
 */
...
/**
 * oval must be non-NULL. NULL oval is no-op; NULL path_builder returns NULL.
 * (SkPathBuilder *path_builder, const SkRect *oval, SkScalar startAngleDeg, SkScalar sweepAngleDeg) -> SkPathBuilder *
 */
...
/**
 * rect must be non-NULL. NULL rect is no-op; NULL path_builder returns NULL.
 * (SkPathBuilder *path_builder, const SkRect *rect, SkPathDirection dir, unsigned startIndex) -> SkPathBuilder *
 */
...
/**
 * rect must be non-NULL. NULL rect is no-op; NULL path_builder returns NULL.
 * (SkPathBuilder *path_builder, const SkRect *rect, SkPathDirection dir) -> SkPathBuilder *
 */
...
/**
 * rect must be non-NULL. NULL rect is no-op; NULL path_builder returns NULL.
 * (SkPathBuilder *path_builder, const SkRRect *rect, SkPathDirection dir, unsigned startIndex) -> SkPathBuilder *
 */
...
/**
 * rrect must be non-NULL. NULL rrect is no-op; NULL path_builder returns NULL.
 * (SkPathBuilder *path_builder, const SkRRect *rrect, SkPathDirection dir) -> SkPathBuilder *
 */
...
/**
 * pts must be non-NULL and count must be greater than 0. Invalid input is no-op; NULL path_builder returns NULL.
 * (SkPathBuilder *path_builder, const SkPoint pts[], int count, bool isClosed) -> SkPathBuilder *
 */
...
/**
 * list must be non-NULL. NULL list is no-op; NULL path_builder returns NULL.
 * (SkPathBuilder *path_builder, const std::initializer_list<SkPoint> *list, bool isClosed) -> SkPathBuilder *
 */
reskia_path_builder_t *SkPathBuilder_addPolygonFromList(reskia_path_builder_t *path_builder, const void *list, bool isClosed);
/**
 * path must be non-NULL. NULL path is no-op; NULL path_builder returns NULL.
 * (SkPathBuilder *path_builder, const SkPath *path) -> SkPathBuilder *
 */
...
/**
 * No-op when path_builder is NULL.
 * (SkPathBuilder *path_builder, int extraPtCount, int extraVerbCount)
 */
...
/**
 * No-op when path_builder is NULL.
 * (SkPathBuilder *path_builder, int extraPtCount)
 */
