...
sk_rect_t SkRect_makeOffsetFromPoint(reskia_rect_t *rect, sk_point_t v); // (SkRect *rect, sk_point_t v) -> sk_rect_t
...
void SkRect_offsetByPoint(reskia_rect_t *rect, const reskia_point_t *delta); // (SkRect *rect, const SkPoint *delta)
...
bool SkRect_intersectFromRects(reskia_rect_t *rect, const reskia_rect_t *a, const reskia_rect_t *b); // (SkRect *rect, const SkRect *a, const SkRect *b) -> bool
