...
bool SkStream_readS64(reskia_stream_t *stream, int64_t *i); // (SkStream *stream, int64_t *i) -> bool
...
bool SkStream_readU64(reskia_stream_t *stream, uint64_t *i); // (SkStream *stream, uint64_t *i) -> bool
