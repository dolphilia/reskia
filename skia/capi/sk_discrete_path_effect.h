...
sk_path_effect_t SkDiscretePathEffect_Make(float segLength, float dev, uint32_t seedAssist); // Returns 0 on failure. (SkScalar segLength, SkScalar dev, uint32_t seedAssist) -> sk_path_effect_t
