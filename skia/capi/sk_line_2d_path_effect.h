...
sk_path_effect_t SkLine2DPathEffect_Make(float width, const reskia_matrix_t *matrix); // matrix は非 NULL。生成不能なら 0 (SkScalar width, const SkMatrix *matrix) -> sk_path_effect_t
