...
int SkIRect_left(reskia_i_rect_t *i_rect); // NULL i_rect returns 0.
...
bool SkIRect_isEmpty(reskia_i_rect_t *i_rect); // NULL i_rect returns true.
void SkIRect_setEmpty(reskia_i_rect_t *i_rect); // NULL i_rect is no-op.
...
sk_i_rect_t SkIRect_makeOffset(reskia_i_rect_t *i_rect, int dx, int dy); // NULL i_rect returns 0.
...
bool SkIRect_containsIRect(reskia_i_rect_t *i_rect, const reskia_i_rect_t *r); // NULL input returns false.
...
sk_i_rect_t SkIRect_MakeSize(const reskia_i_size_t *size); // size required; invalid input returns 0.
...
bool SkIRect_Intersects(const reskia_i_rect_t *a, const reskia_i_rect_t *b); // NULL input returns false.
