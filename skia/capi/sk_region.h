...
bool SkRegion_intersectsRegion(reskia_region_t *region, const reskia_region_t *other); // (SkRegion *region, const SkRegion *other) -> bool
bool SkRegion_contains(reskia_region_t *region, int x, int y); // (SkRegion *region, int32_t x, int32_t y) -> bool
bool SkRegion_containsIRect(reskia_region_t *region, const reskia_i_rect_t *other); // (SkRegion *region, const SkIRect *other) -> bool
bool SkRegion_containsRegion(reskia_region_t *region, const reskia_region_t *other); // (SkRegion *region, const SkRegion *other) -> bool
...
bool SkRegion_quickRejectRegion(reskia_region_t *region, const reskia_region_t *rgn); // (SkRegion *region, const SkRegion *rgn) -> bool
void SkRegion_translate(reskia_region_t *region, int dx, int dy); // (SkRegion *region, int dx, int dy)
void SkRegion_translateToRegion(reskia_region_t *region, int dx, int dy, reskia_region_t *dst); // (SkRegion *region, int dx, int dy, SkRegion *dst)
...
bool SkRegion_opWithRegion(reskia_region_t *region, const reskia_region_t *rgn, reskia_region_op_t op); // (SkRegion *region, const SkRegion *rgn, SkRegion::Op op) -> bool
bool SkRegion_opWithIRectAndRegion(reskia_region_t *region, const reskia_i_rect_t *rect, const reskia_region_t *rgn, reskia_region_op_t op); // (SkRegion *region, const SkIRect *rect, const SkRegion *rgn, SkRegion::Op op) -> bool
bool SkRegion_opWithRegionAndIRect(reskia_region_t *region, const reskia_region_t *rgn, const reskia_i_rect_t *rect, reskia_region_op_t op); // (SkRegion *region, const SkRegion *rgn, const SkIRect *rect, SkRegion::Op op) -> bool
