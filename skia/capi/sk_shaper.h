...
typedef struct reskia_shapers_factory_t reskia_shapers_factory_t;
...
reskia_unicode_t *SkShapers_Factory_getUnicode(reskia_shapers_factory_t *factory); // borrowed; do not delete
