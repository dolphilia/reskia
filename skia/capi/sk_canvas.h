...
void SkCanvas_drawImageHandleWithSampling(reskia_canvas_t *canvas, sk_image_t image, float x, float y, const reskia_sampling_options_t *sampling, const reskia_paint_t *paint); // image/sampling: non-null; paint may be NULL (SkCanvas *canvas, sk_image_t image, SkScalar x, SkScalar y, const SkSamplingOptions *sampling, const SkPaint *paint)
