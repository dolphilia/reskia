...
void SkCanvas_drawDRRect(reskia_canvas_t *canvas, const reskia_r_rect_t *outer, const reskia_r_rect_t *inner, const reskia_paint_t *paint); // outer/inner/paint: non-null (SkCanvas *canvas, const SkRRect *outer, const SkRRect *inner, const SkPaint *paint)
