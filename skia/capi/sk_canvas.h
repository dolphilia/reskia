...
void SkCanvas_drawVertices(reskia_canvas_t *canvas, sk_vertices_t vertices, reskia_blend_mode_t mode, const reskia_paint_t *paint); // vertices/paint: non-null (SkCanvas *canvas, sk_vertices_t vertices, SkBlendMode mode, const SkPaint *paint)
void SkCanvas_drawVerticesPtr(reskia_canvas_t *canvas, const reskia_vertices_t *vertices, reskia_blend_mode_t mode, const reskia_paint_t *paint); // vertices/paint: non-null (SkCanvas *canvas, const SkVertices *vertices, SkBlendMode mode, const SkPaint *paint)
