...
void SkCanvas_drawDrawable(reskia_canvas_t *canvas, reskia_drawable_t *drawable, const reskia_matrix_t *matrix); // drawable: non-null; matrix may be NULL (SkCanvas *canvas, SkDrawable *drawable, const SkMatrix *matrix)
void SkCanvas_drawDrawableAt(reskia_canvas_t *canvas, reskia_drawable_t *drawable, float x, float y); // drawable: non-null (SkCanvas *canvas, SkDrawable *drawable, SkScalar x, SkScalar y)
