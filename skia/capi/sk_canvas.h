...
void SkCanvas_drawTextBlobPtr(reskia_canvas_t *canvas, const reskia_text_blob_t *blob, float x, float y, const reskia_paint_t *paint); // blob/paint: non-null (SkCanvas *canvas, const SkTextBlob *blob, SkScalar x, SkScalar y, const SkPaint *paint)
