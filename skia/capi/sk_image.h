...
sk_shader_t SkImage_makeShader(reskia_image_t *image, reskia_image_tile_mode_t tmx, reskia_image_tile_mode_t tmy, const reskia_sampling_options_t *sampling, const reskia_matrix_t *localMatrix); // image/sampling: non-null; localMatrix may be NULL; returned shader handle is caller-owned; invalid input or factory failure returns 0 (SkImage *image, SkTileMode tmx, SkTileMode tmy, const SkSamplingOptions *sampling, const SkMatrix *localMatrix) -> sk_shader_t
sk_shader_t SkImage_makeShaderWithTileModesAndLocalMatrix(reskia_image_t *image, reskia_image_tile_mode_t tmx, reskia_image_tile_mode_t tmy, const reskia_sampling_options_t *sampling, const reskia_matrix_t *lm); // image/sampling/lm: non-null; returned shader handle is caller-owned; invalid input or factory failure returns 0 (SkImage *image, SkTileMode tmx, SkTileMode tmy, const SkSamplingOptions *sampling, const SkMatrix *lm) -> sk_shader_t
sk_shader_t SkImage_makeShaderWithSamplingAndLocalMatrix(reskia_image_t *image, const reskia_sampling_options_t *sampling, const reskia_matrix_t *lm); // image/sampling/lm: non-null; returned shader handle is caller-owned; invalid input or factory failure returns 0 (SkImage *image, const SkSamplingOptions *sampling, const SkMatrix *lm) -> sk_shader_t
sk_shader_t SkImage_makeShaderWithSampling(reskia_image_t *image, const reskia_sampling_options_t *sampling, const reskia_matrix_t *lm); // image/sampling: non-null; lm may be NULL; returned shader handle is caller-owned; invalid input or factory failure returns 0 (SkImage *image, const SkSamplingOptions *sampling, const SkMatrix *lm) -> sk_shader_t
...
sk_shader_t SkImage_makeRawShaderWithSamplingAndLocalMatrix(reskia_image_t *image, const reskia_sampling_options_t *sampling, const reskia_matrix_t *lm); // image/sampling/lm: non-null; returned shader handle is caller-owned; invalid input or factory failure returns 0 (SkImage *image, const SkSamplingOptions *sampling, const SkMatrix *lm) -> sk_shader_t
sk_shader_t SkImage_makeRawShaderWithSampling(reskia_image_t *image, const reskia_sampling_options_t *sampling, const reskia_matrix_t *lm); // image/sampling: non-null; lm may be NULL; returned shader handle is caller-owned; invalid input or factory failure returns 0 (SkImage *image, const SkSamplingOptions *sampling, const SkMatrix *lm) -> sk_shader_t
bool SkImage_peekPixels(reskia_image_t *image, reskia_pixmap_t *pixmap); // pixmap: non-null out param; returned pixmap borrows image pixels; invalid input returns false (SkImage *image, SkPixmap *pixmap) -> bool
bool SkImage_isTextureBacked(reskia_image_t *image); // NULL image returns false (SkImage *image) -> bool
size_t SkImage_textureSize(reskia_image_t *image); // NULL image returns 0 (SkImage *image) -> size_t
bool SkImage_isValid(reskia_image_t *image, reskia_recording_context_t *context); // image: non-null; context may be NULL; NULL image returns false (SkImage *image, GrRecordingContext *context) -> bool
bool SkImage_readPixels(reskia_image_t *image, reskia_direct_context_t *context, const reskia_image_info_t *dstInfo, void *dstPixels, size_t dstRowBytes, int srcX, int srcY, reskia_image_caching_hint_t cachingHint); // image/dstInfo/dstPixels: non-null; context may be NULL; dstRowBytes must satisfy dstInfo.validRowBytes; invalid input returns false (SkImage *image, GrDirectContext *context, const SkImageInfo *dstInfo, void *dstPixels, size_t dstRowBytes, int srcX, int srcY, SkImage::CachingHint cachingHint) -> bool
bool SkImage_readPixelsWithContextPixmap(reskia_image_t *image, reskia_direct_context_t *context, const reskia_pixmap_t *dst, int srcX, int srcY, reskia_image_caching_hint_t cachingHint); // image/dst pixmap: non-null; context may be NULL; invalid input returns false (SkImage *image, GrDirectContext *context, const SkPixmap *dst, int srcX, int srcY, SkImage::CachingHint cachingHint) -> bool
...
bool SkImage_scalePixels(reskia_image_t *image, const reskia_pixmap_t *dst, const reskia_sampling_options_t *sampling, reskia_image_caching_hint_t cachingHint); // image/dst/sampling: non-null; dst must have writable storage; invalid input returns false (SkImage *image, const SkPixmap *dst, const SkSamplingOptions *sampling, SkImage::CachingHint cachingHint) -> bool
sk_data_t SkImage_refEncodedData(reskia_image_t *image); // retained handle; caller deletes with static_sk_data_delete; NULL image or no encoded data returns 0 (SkImage *image) -> sk_data_t
sk_image_t SkImage_makeSubset(reskia_image_t *image, reskia_direct_context_t *direct, const reskia_i_rect_t *subset); // image/subset: non-null; direct may be NULL; returned handle is caller-owned; returns 0 on invalid input or factory failure (SkImage *image, GrDirectContext *direct, const SkIRect *subset) -> sk_image_t
...
sk_image_t SkImage_withDefaultMipmaps(reskia_image_t *image); // image: non-null; returned handle is caller-owned; returns 0 on invalid input or factory failure (SkImage *image) -> sk_image_t
sk_image_t SkImage_makeNonTextureImage(reskia_image_t *image, reskia_direct_context_t *context); // image: non-null; context may be NULL; returns 0 on invalid input or factory failure (SkImage *image, GrDirectContext *context) -> sk_image_t
sk_image_t SkImage_makeRasterImage(reskia_image_t *image, reskia_direct_context_t *context, reskia_image_caching_hint_t cachingHint); // image: non-null; context may be NULL; returned handle is caller-owned; returns 0 on invalid input or factory failure (SkImage *image, GrDirectContext *context, SkImage::CachingHint cachingHint) -> sk_image_t
sk_image_t SkImage_makeRasterImageWithoutContext(reskia_image_t *image, reskia_image_caching_hint_t cachingHint); // image: non-null; returned handle is caller-owned; returns 0 on invalid input or factory failure (SkImage *image, SkImage::CachingHint cachingHint) -> sk_image_t
...
sk_image_t SkImage_makeColorSpace(reskia_image_t *image, reskia_direct_context_t *direct, sk_color_space_t color_space); // image: non-null; direct may be NULL; color_space handle 0 is allowed as null color space; non-zero color_space must be valid; returns 0 on invalid input or factory failure (SkImage *image, GrDirectContext *direct, sk_color_space_t color_space) -> sk_image_t
