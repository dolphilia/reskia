...
reskia_overdraw_canvas_t *SkOverdrawCanvas_new(reskia_canvas_t *canvas); // canvas must be non-NULL. Invalid input returns NULL
void SkOverdrawCanvas_delete(reskia_overdraw_canvas_t *overdraw_canvas); // NULL input is no-op
/**
 * blob and paint must be non-NULL. Invalid input is a no-op.
 */
...
/**
 * glyphRunList and paint must be non-NULL. Invalid input is a no-op.
 */
...
/**
 * point1[12] and paint must be non-NULL. color[4] and point2[4] may be NULL. Invalid input is a no-op.
 */
...
void SkOverdrawCanvas_onDrawPaint(reskia_overdraw_canvas_t *overdraw_canvas, const reskia_paint_t *paint); // paint must be non-NULL. Invalid input is a no-op.
void SkOverdrawCanvas_onDrawBehind(reskia_overdraw_canvas_t *overdraw_canvas, const reskia_paint_t *paint); // paint must be non-NULL. Invalid input is a no-op.
/**
 * rect and paint must be non-NULL. Invalid input is a no-op.
 */
...
/**
 * region and paint must be non-NULL. Invalid input is a no-op.
 */
...
/**
 * rect1, rect2, and paint must be non-NULL. Invalid input is a no-op.
 */
...
/**
 * point must be non-NULL when size > 0. paint must be non-NULL. Invalid input is a no-op.
 */
...
/**
 * vertices and paint must be non-NULL. Invalid input is a no-op.
 */
...
/**
 * path and paint must be non-NULL. Invalid input is a no-op.
 */
...
/**
 * image and options must be non-NULL. paint may be NULL. Invalid input is a no-op.
 */
...
/**
 * image, rect1, rect2, and options must be non-NULL. paint may be NULL. Invalid input is a no-op.
 */
...
/**
 * image, lattice, and rect must be non-NULL. paint may be NULL. Invalid input is a no-op.
 */
...
/**
 * form and rect1 must be non-NULL and have at least v elements when v > 0. color, rect2, and paint may be NULL. Invalid input is a no-op.
 */
...
/**
 * drawable must be non-NULL. matrix may be NULL. Invalid input is a no-op.
 */
...
/**
 * picture must be non-NULL. matrix and paint may be NULL. Invalid input is a no-op.
 */
...
/**
 * rect and key must be non-NULL. value may be NULL. Invalid input is a no-op.
 */
...
/**
 * path and rec must be non-NULL. Invalid input is a no-op.
 */
...
/**
 * rect, point[4], and color must be non-NULL. Invalid input is a no-op.
 */
...
/**
 * entry must be non-NULL when count > 0. point, matrix, and paint may be NULL. options must be non-NULL. Invalid input is a no-op.
 */
