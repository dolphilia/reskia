...
void SkOpBuilder_add(reskia_op_builder_t *op_builder, const reskia_path_t *path, reskia_op_builder_path_op_t path_operator); // op_builder/path は非 NULL、path_operator は SkPathOp 範囲内。invalid 入力では no-op
