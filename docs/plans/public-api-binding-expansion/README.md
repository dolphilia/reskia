...
- callback/global registration は `01-callback-global-registration-design.md` の方針に従う。実装は Phase 3 の SVG DOM 最小公開後、Phase 5 の skottie/skresources provider 実装前に `Phase 5A` としてまとめる。
