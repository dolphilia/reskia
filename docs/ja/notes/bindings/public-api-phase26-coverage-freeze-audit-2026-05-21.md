...
`docs/ja/notes/bindings/public-api-phase29-final-coverage-freeze-2026-05-21.md`.

## Snapshot

Source: `docs/ja/plans/c-binding-remediation/checklists/public-api-coverage-matrix.csv`
