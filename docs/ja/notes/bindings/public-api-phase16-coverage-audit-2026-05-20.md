...
`docs/ja/notes/bindings/public-api-phase26-coverage-freeze-audit-2026-05-21.md`.

## Snapshot

Latest `docs/ja/plans/c-binding-remediation/checklists/public-api-coverage-matrix.csv`:
...
- `docs/ja/plans/c-binding-remediation/checklists/public-api-phase-16-current-missing-routing.csv`
