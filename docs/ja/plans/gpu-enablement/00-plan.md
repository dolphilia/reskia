...
`docs/ja/notes/reskia-feature-gap-survey-2026-02-14.md` の `3.6 GPU（Ganesh/Graphite、Vulkan/Metal/Dawn）` を再調査し、Reskia で GPU バックエンドを段階的に有効化しつつ、C API から利用できる状態にする。
...
- `docs/ja/notes/reskia-feature-gap-survey-2026-02-14.md`
...
1. `docs/ja/notes/reskia-feature-gap-survey-2026-02-14.md` の `3.6` を進捗に合わせて更新する。
2. `docs/ja/plans/gpu-enablement/` に backend 別の詳細メモ（依存、制約、未対応）を追記する。
