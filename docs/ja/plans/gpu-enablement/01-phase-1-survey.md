...
- `docs/ja/plans/gpu-enablement/manifests/phase1-upstream-gpu-files.txt`
- `docs/ja/plans/gpu-enablement/manifests/phase1-reskia-gpu-files.txt`
- `docs/ja/plans/gpu-enablement/manifests/phase1-gpu-diff.txt`
- `docs/ja/plans/gpu-enablement/manifests/phase1-backend-prerequisites.md`
...
```bash
mkdir -p docs/ja/plans/gpu-enablement/manifests
find vendor/skia-upstream/src/gpu -type f | sed 's#^vendor/skia-upstream/src/gpu/##' | sort > docs/ja/plans/gpu-enablement/manifests/phase1-upstream-gpu-files.txt
find skia/src/gpu -type f | sed 's#^skia/src/gpu/##' | sort > docs/ja/plans/gpu-enablement/manifests/phase1-reskia-gpu-files.txt
comm -23 docs/ja/plans/gpu-enablement/manifests/phase1-upstream-gpu-files.txt \
  docs/ja/plans/gpu-enablement/manifests/phase1-reskia-gpu-files.txt \
  > docs/ja/plans/gpu-enablement/manifests/phase1-gpu-diff.txt
```
