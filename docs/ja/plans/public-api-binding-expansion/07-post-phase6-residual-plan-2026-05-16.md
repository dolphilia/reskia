...
- 前提: Phase 6 は完了扱い
- coverage 入力: `docs/ja/plans/c-binding-remediation/checklists/public-api-coverage-matrix.csv`
...
- `python3 scripts/generate_public_api_coverage.py --repo . --output docs/ja/plans/c-binding-remediation/checklists/public-api-coverage-matrix.csv`
