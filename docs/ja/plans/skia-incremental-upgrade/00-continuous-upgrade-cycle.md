...
- `docs/ja/notes/vendor-skia-management-2026-02-14.md`
- `docs/ja/plans/public-api-binding-expansion/08-post-phase10-coverage-expansion-plan-2026-05-16.md`
...
- `docs/ja/plans/skia-incremental-upgrade/records/` に cycle record を作る。
...
cp docs/ja/plans/c-binding-remediation/checklists/public-api-coverage-matrix.csv \
