...
- `docs/ja/plans/skottie-enablement/manifests/upstream-sksg-files.txt`
- `docs/ja/plans/skottie-enablement/manifests/local-sksg-files.txt`
- `docs/ja/plans/skottie-enablement/manifests/upstream-skottie-files.txt`
- `docs/ja/plans/skottie-enablement/manifests/local-skottie-files.txt`
- `docs/ja/plans/skottie-enablement/manifests/phase1-selected-module-files.txt`
