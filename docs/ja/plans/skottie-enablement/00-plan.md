...
`docs/ja/notes/reskia-feature-gap-survey-2026-02-14.md` の `3.3 skottie（Lottie アニメーション）` を「未対応」から改善し、少なくとも以下を満たす。
...
2. 依存条件、既定値、ON/OFF 時挙動、既知制約（GPU 非対象など）を `docs/ja/notes` または `docs/ja/guides` に反映する。
