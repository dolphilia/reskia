...
- `docs/ja/plans/pdf-enablement/manifests/upstream-src-pdf-files.txt`
- `docs/ja/plans/pdf-enablement/manifests/reskia-src-pdf-files.txt`
- `docs/ja/plans/pdf-enablement/manifests/missing-src-pdf-files.txt`
- `docs/ja/plans/pdf-enablement/manifests/skpdfdocument-direct-includes.txt`
- `docs/ja/plans/pdf-enablement/manifests/pdf-cpp-include-closure.txt`
- `docs/ja/plans/pdf-enablement/manifests/pdf-conditional-external-deps.txt`
- `docs/ja/plans/pdf-enablement/manifests/phase1-selected-src-pdf-files.txt`
