...
`docs/ja/notes/reskia-feature-gap-survey-2026-02-14.md` の `3.2 SVG / テキストシェーピング` を「部分網羅（最小縮退中心）」から改善し、以下を満たす。
...
3. 依存縮退条件と有効化手順を `docs/ja/notes` または `docs/ja/guides` に反映する。
