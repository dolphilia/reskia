...
1. `docs/ja/notes/reskia-feature-gap-survey-2026-02-14.md` の `3.4 skparagraph` を未対応から実装反映状態へ更新。
...
- `docs/ja/plans/skparagraph-enablement/05-phase-5-smoke-and-docs.md`（本ファイル）
